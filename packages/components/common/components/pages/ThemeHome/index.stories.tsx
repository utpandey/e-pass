  ...
  children: (
    <div className="flex">
      <div className="flex flex-col">
        <Text label="OIL & GAS" textSize="text-4xl" weight={400} />
        <Text label="14k Invested 70k Followers" textStyles="m-0" />
        <Button
          primary={true}
          label="FOLLOW"
      ...
      <div className="flex flex-col flex-auto items-end">
        ...
        <Text label="Upcoming IPOs" textStyles="" weight={400} />
        <Card>
          <div className="rounded py-4 px-4 my-2 bg-gray-200 max-w-xs  space-y-2 space-x-4 sm:py-4 flex w-auto">
            <Avatar
            ...
            <Text
              ...
              textStyles="text-center"
            />
            <Text label="72-76" color="black" textStyles="text-center" />
          </div>
        </Card>
        <Button
          primary={true}
